...
comment: initially deviced a cumbersome and verbose implementation and couldn't implement it anyway. 
simplifying logic later helped solve. should've done this initially and would've solved faster.
